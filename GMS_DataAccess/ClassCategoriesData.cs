...
namespace GMS_DataAccess
{
    public class ClassCategoriesData
    {
        ...
        public static bool update(int Id, string name) => CRUD.executeNonQuery($"UPDATE ClassCategories SET Name: {name} WHERE Id = {Id}");
        ...
        => CRUD.getUsingDateTable(@$"SELECT ClassTypes.Id, ClassTypes.Name, ClassTypes.Fees, ClassTypes.ImagePath,
                                    ClassCategories.Name AS CategoryName, ClassTypes.CoachId, ClassTypes.CategoryId
