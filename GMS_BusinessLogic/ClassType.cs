...
namespace GMS_BusinessLogic
{
    public class ClassType
    {
        ...
        private ClassType(int id, string name, float fees,
            bool allowFreeze, string? imagePath, int categoryId)
        {
            Id = id;
            Name = name;
            Fees = fees;
        ...
        public static ClassType find(int id)
        {
            ...
            if (ClassTypesData.getClassDataTypesById(id, ref name, ref fees,
                ref allowFreeze, ref imagePath, ref categoryId))

                return new ClassType(id, name, fees, allowFreeze, imagePath, categoryId);
        ...
        => obj.Id = ClassTypesData.add(obj.Name, obj.Fees, obj.AllowFreeze, obj.ImagePath, obj.CategoryId);

        public bool update(ClassType obj)
        => ClassTypesData.update(obj.Id, obj.Name, obj.Fees, obj.AllowFreeze, obj.ImagePath, obj.CategoryId);
